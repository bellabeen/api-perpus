...
class Pengarang{
    ...
    // private $table_name1 = "detil_pengarang";
    ...
    function createPengarang(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                id_pengarang=:id_pengarang, nama_pengarang=:nama_pengarang";
        ...
        $this->nama_pengarang=htmlspecialchars(strip_tags($this->nama_pengarang));
    
        // bind values
        $stmt->bindParam(":id_pengarang", $this->id_pengarang);
        $stmt->bindParam(":nama_pengarang", $this->nama_pengarang);
    ...
    // delete the product
    function deletePengarang(){
    
        // delete query
        $query = "DELETE FROM " . $this->table_name . " WHERE id_pengarang = ?";
        ...
        $stmt->bindParam(1, $this->id_pengarang);
...
//Detail Pengarang Function

            // read products
            function readDetailPengarang(){
    ...
    // create product
    function createDetailPengarang(){
    
        // query to insert record
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                    id_buku=:id_buku, id_pengarang=:id_pengarang, ket=:ket";
    ...
    // delete the product
    function deleteDetailPengarang(){
